            ...
            <Container>
                <div className="-mx-4 flex flex-wrap items-center justify-center">
                    <div className="w-full px-4 md:w-1/2 xl:w-2/5">
                        <div className="mx-auto mb-10 w-full max-w-[370px]">
                            <div className="space-y-5 mx-auto">
                                <h2 className="font-lora md:text-5xl text-3xl font-medium sm:text-start text-center">
                                    Let your resume do the work.
                                </h2>
                                <p className="font-montserrat text-base sm:text-start text-center">
                    ...
                    <div className="w-full px-4 md:w-1/2 xl:w-1/5">
                        <div className="mb-10 sm:mx-0 mx-auto w-full max-w-[260px]">
