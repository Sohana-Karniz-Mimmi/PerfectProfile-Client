        ...
        <div className="space-y-6 sm:space-y-12">
          <div className="text-center mb-12">
            <Heading
              ...
              subtitle={
                "We provide the best online resume builder and free expert career advice to guide you through the recruitment process to land your dream job."
              }
          ...
          <AboutCompany
            img={certified}
            heading={`Our mission`}
            text={`We empower job seekers with the tools they need to achieve their career goals. Our team of experts is dedicated to helping you every step of the way, from providing tools to create a showstopping resume and cover letter to offering professional interview tips and career guidance.`}
          />
          <div className="flex md:flex-row flex-col-reverse justify-between items-center gap-4">
            ...
            <div>
              ...
              <p className="xl:max-w-[547px] md:max-w-[380px] text-sm md:text-[17px] md:mb-0 mb-6 mt-4 font-montserrat font-light text-gray-800">
                We envision a world where every job seeker has access to the
                resources they need to succeed, and we are committed to being
                the driving force behind this change. Our goal is to help job
                seekers present their skills and experience in the best possible
                light, giving them the confidence and competitive edge to land
                their dream job.
              </p>
            </div>
          </div>
