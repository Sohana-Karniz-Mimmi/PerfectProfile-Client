import team4 from "../../assets/Images/About/team5.jpg"
                ...
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4">
                        <div className="mx-auto mb-[60px] max-w-[510px] text-center">
                            ...
                            <Heading
                                title={' Meet our team'}
                                subtitle={'If you want the best care possible for your real estate needs, our certified professionals are here to help'}
                                className={''} />
                            ...
                            <div className="relative overflow-hidden rounded-lg">
                                ...
                                <div className="absolute bottom-5 left-0 w-full text-center">
                                    ...
                                    >
                                        ...
                                        <p className="text-body-color dark:text-[#909397] text-xs">Editor in Chief / Resume Writer</p>
                                        <div>
                                            <span className="absolute left-0 bottom-0">
                                                <svg
                                                    width="61"
