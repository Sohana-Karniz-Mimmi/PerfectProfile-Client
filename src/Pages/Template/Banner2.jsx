    ...
    <div className="mb-40 mt-36 ">
      <div>
        <h1 className="font-bold text-4xl text-center ">
          Why{" "}
          <span className=" border-b-4 rounded-sm border-primary">Choose</span>{" "}
          <span>
            P<span>er</span>fect
        ...
        <motion.div
          ...
          className="grid grid-cols-2 gap-7 pl-24 mt-10 mb-[16rem] p-16 items-center justify-center "
        >
          {/* feature 1 */}
          <div className="flex gap-4">
            ...
            <div className="w-[27rem] space-y-2">
              ...
              <p className="text-gray-500">
                Access a curated collection of stylish and modern templates
                designed to make your resume stand out.Whether it's a classic
                black-and-white template, or something a bit more outside the
                box, we have what you need!
              </p>
            </div>
          </div>
          {/* feature 2 */}
          <div className="flex gap-4">
            ...
            <div className="w-[27rem] space-y-2">
              ...
              <p className="text-gray-500">
                Customize every aspect of your resume with our user-friendly
                editor. Whether you want to tweak the font or layout,
                PerfectProfile provides the flexibility to make your resume
                truly your own.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div className="w-[27rem] space-y-2">
              ...
              <p className="text-gray-500">
                We offer one-on-one coaching to help you craft the perfect
                resume. Our expert coaches guide you through each section,
                providing personalized advice tailored to your career goals.{" "}
              </p>
            </div>
          </div>
          {/* feature 4 */}
          <div className="flex gap-1">
            ...
            <div className="w-[27rem] space-y-2">
              ...
              <p className="text-gray-500">
                Whether you're getting feedback from a mentor, collaborating
                with a colleague, or working alongside a career coach, everyone
                review your resume.Ensuring your resume is polished to
                perfection with input from trusted collaborators.
              </p>
            </div>
          </div>
          {/* feature 5 */}
          <div className="flex gap-2">
            ...
            <div className="w-[27rem] space-y-2">
              <h1 className="font-bold text-2xl">
                Instant PDF Download & Share Links
              </h1>
              <p className="text-gray-500">
                Download your resume in high-quality PDF format or generate a
                shareable link, making it easy to send your resume to recruiters
                instantly
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <div className="w-[27rem] space-y-2">
              ...
              <p className="text-gray-500">
                Choose a plan that aligns with your career goals and budget.From
                a free plan that gives you access to essential tools, to premium
                packages with enhanced customization and real-time
                collaboration, we ensure there's an option for everyone.
              </p>
            </div>
          </div>
        </motion.div>
