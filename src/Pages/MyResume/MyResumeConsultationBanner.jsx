...
const MyResumeConsultationBanner = () => {
  return (
    <div
      className="flex flex-col md:flex-row justify-between items-center px-5 md:px-9 py-8 mb-9 lg:mb-20 lg:h-[20rem] mt-6 rounded-lg bg-cyan-50 gap-5"
      style={{ boxShadow: "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" }}
    >
      <div>
        <h1 className="font-bold text-2xl md:text-3xl lg:text-4xl">
          Struggling with Your Resume? Our Experts Are Here to Help.
        </h1>
        <p className="text-gray-500  text-sm md:text-[15px] lg:text-base  xl:w-[44rem] lg:w-[43rem] md:w-[28rem] mt-5">
          ...
          do it alone. Our team of experienced consultants is here to guide you
          every step of the way, helping you create a resume that highlights
          your skills and achievements. Whether you're starting from scratch or
          refining an existing resume, our personalized sessions offer tailored
          advice to ensure your resume shines. Book a consultation today and
        ...
        <div className="flex flex-col md:items-start items-center text-base  font-bold lg:font-semibold">
          <a href="/consultants" className="mt-5 ">
      ...
      <div className="flex relative item-center justify-center">
        <img
          ...
          alt=""
        />
        <div className="bg-[#3da4bb] lg:w-[125px] w-[107px] lg:h-5 h-3 flex gap-[15px] p-1 absolute lg:top-[26px] top-[18px] lg:right-[42px]  items-center justify-center right-[40px] text-white lg:text-[9px] text-[6px] rounded-sm">
          <ul className="list-disc list-inside flex items-center justify-center ">
            <li>online</li>
          </ul>{" "}
          Resume Session
        </div>
