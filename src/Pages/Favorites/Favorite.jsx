  ...
  return (
    ...
    >
      <Container>
        ...
        {/* banner */}
        <div
          className="flex flex-col md:flex-row justify-between items-center px-5 md:px-9 py-8 mb-9 lg:mb-7 mt-6 rounded-lg bg-cyan-50 gap-5"
        ...
        >
          <div>
            ...
            <p className="text-gray-500 text-sm md:text-[15px] lg:text-base lg:w-[43rem] mt-3">
              Curate your perfect collection of resume templates with ease.
              Here, you can find all your favorite designs saved in one place.
            </p>
            <p className="text-gray-500 text-sm md:text-[15px] lg:text-base lg:w-[43rem] mt-2">
              Find the perfect template that resonates with your personality,
              and start building your dream resume today!
            </p>
