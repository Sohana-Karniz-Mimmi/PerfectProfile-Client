        ...
        <div className="flex flex-col items-center mx-auto">
          <div>
            <h1 className=" lg:w-[800px] mt-3 text-2xl font-semibold text-gray-800  md:text-3xl">
              Oops! It looks like the page you're trying to access can't be
              found. Something Went Wrong!
            </h1>
            ...
            <ul className="mt-3 list-disc ml-10 text-gray-500">
              ...
              <li>
                Check this browser has permission to access the web (you might
                be connected but behind a firewall)
              </li>
            </ul>
          </div>
