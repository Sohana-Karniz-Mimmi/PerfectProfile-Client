...
const WhyNeedSection = () => {
    return (
        <div>
          <h1 className="font-bold lg:text-4xl lg:mt-24mt-20 text-3xl text-center ">Why Seek Help from Resume <span className=" border-b-4 rounded-sm border-primary">Experts</span> <span>
               ?
              </span></h1>
