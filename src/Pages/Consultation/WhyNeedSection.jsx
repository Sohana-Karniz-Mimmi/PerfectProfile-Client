...
const WhyNeedSection = () => {
    return (
        <div>
          <h1 className="font-bold lg:text-4xl mt-28 text-2xl text-center ">Why Seek Help from Resume <span className=" border-b-4 rounded-sm border-primary">Experts</span> <span>
               ?
              </span></h1>
