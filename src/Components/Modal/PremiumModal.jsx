...
const PremiumModal = () => {
  ...
  return (
    <dialog id="premium-modal" className="modal h32">
        ...
        <div className="fixed z-50 inset-0 flex items-center justify-center bg-black bg-opacity-50 ">
          <div className="bg-white p-6 rounded-md ">
            ...
            <div className="modal-action mt-4 flex justify-end">
              <button
                className="btn bg-gray-300 text-black py-2 px-4 rounded mr-2"
                onClick={() => document.getElementById("premium-modal").close()}
              >
                Cancel
              </button>
              <Link to={"/pricing"}>
