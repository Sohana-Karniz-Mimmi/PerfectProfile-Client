  ...
  return (
    <Container className="">
      ...
      >
        ...
        {/* standard */}
        <div className=" bg-base-100 lg:w-2/3 md:max-w-md md:mx-auto w-full lg:h-[40rem] md:h-[43rem]  h-[44rem]  shadow-xl relative transition-transform duration-300 hover:scale-105">
          ...
          <div className="card-body pt-6 px-8">
            ...
            <div className="buy-btn justify-center lg:mt-9 mt-1">
              {/* standard button */}
        ...
        {/* premium */}
        <div className=" bg-base-100 lg:w-2/3 md:max-w-md md:mx-auto w-full lg:h-[40rem] md:h-[43rem] h-[44rem] relative  shadow-xl transition-transform duration-300 hover:scale-105">
          <div className="flex justify-end ">
            <figure>
              <img src={priceImg} alt="price" />
            </figure>
          ...
          <div className="relative card-body pt-6 px-8">
            ...
            <div>
              <p className="text-gray-600 mb-4 mt-2  font-montserrat">
                Save 20% and unlock all premium features with our affordable yearly package.
                Build, customize, and optimize your resume effortlessly to stand
                out from the competition!
              </p>
              <ul className="font-roboto">
