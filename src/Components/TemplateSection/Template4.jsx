   ...
   <div className="px-7 py-3 ">
         ...
         {careerObjective && (
           <section className="mb-1">
             <h2 className=" uppercase text-sm  font-semibold  text-center  bg-gray-400">Career Objective</h2>
         ...
         {skills && skills.length > 0 && (
           <section className="mb-1">
             <h2 className=" uppercase text-sm font-semibold  text-center  bg-gray-400 ">skills</h2>
         ...
         {education && education.length > 0 && (
           <section className="mb-1">
             <h2 className=" uppercase text-sm font-semibold  text-center  bg-gray-400 ">Education</h2>
         ...
         {certifications && certifications.length > 0 && (
           <section className="mb-1">
             <h2 className=" uppercase text-sm font-semibold  text-center  bg-gray-400 ">Certifications</h2>
         ...
         {workExperience && workExperience.length > 0 && (
           <section className="mb-1">
             <h2 className="  text-sm uppercase font-semibold  text-center  bg-gray-400 ">Work Experience</h2>
         ...
         {extraCurricularActivities && extraCurricularActivities.length > 0 && (
           <section className="mb-1">
             <h2 className="  text-sm uppercase font-semibold  text-center  bg-gray-400">Extra Curricular Activities</h2>
             <ul className="mt-1 text-sm space-y-1">
         ...
         <li key={index} className="text-gray-600">
           ...
           <section className="mb-1">
             <h2 className=" uppercase text-sm font-semibold  text-center  bg-gray-400 ">language</h2>
             <ul className="mt-1 text-sm  grid grid-cols-2 justify-between list-disc list-inside">
